...
Generated Data (from Generator) --> Discriminator --> Real/Fake?

Generator: random noise → fake data
Discriminator: real data OR fake data → classification
...
Topic Chosen: Misinformation in generative AI.
...
Opinion:
Yes, generative AI models should be restricted from training on private and copyrighted data.
Justification: To respect data privacy, copyright law, and avoid ethical breaches.

Q6: Bias & Fairness Tools
Tool: Aequitas Bias Audit Tool.
